			...
			<div id="wrapper" style="background-color: rgba(0,0,0,0.74)" >
				...
				<!-- Header -->
					...
					<header id="header">
						...
						<div class="content">
                        <br/>
                       <h1> Rechercher commission </h1>
                       <br/>
                       
                    <input type="text" name="search_text" id="search_text" placeholder="Recherche par la date .  " class="form-control" /><br/>
   					<div id="result"></div>
                        </div>
