...
mysql_connect("localhost", "root", ""	);
 ...
 $query3 = "DELETE FROM RelPVInf WHERE idPV ='".$row1['idPV']."'";
 $result3=mysql_query($query3);
 $query2 = "DELETE FROM ProcesVerbal WHERE numPermis ='".$row['numPermis']."'";
 $result2=mysql_query($query2);
 $sql = "DELETE FROM PermisConduire WHERE idPC = '".$_POST["idPC"]."'";  
 if(mysql_query($sql))  
 {  
      echo 'Permis de conduire supprimé avec succé !! ';  
 }  
