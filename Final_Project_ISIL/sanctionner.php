	...
	<!-- Wrapper -->
				...
				<!-- Footer -->
                    ...
                    <b> <div id="ejs_heure"  align="right">   </div> </b>
                     ...
                     <form action="accueil.php?#sanc"> <input  id="gr"align="left" type="submit" value="RETOUR"></form>
...
$(document).on('click', '.btn_delete', function(){  
           var idCommission=$(this).data("id4");  
...
function edit_data(idSanction,text,column)  
      {  
           $.ajax({  
                url:"page25.php",  
                method:"POST",  
                data:{idSanction:idSanction, text:text, column:column},  
                dataType:"text",  
                success:function(data){
				fetch_PV();}  
           });  
...
$(document).on('blur', '.payement', function(){  
           var idSanction = $(this).data("id7");  
		   var payement = $(this).text(); 
           edit_data(idSanction, payement, "payement");  
      });
$(document).on('blur', '.dateFin', function(){  
           var idSanction = $(this).data("id8");  
		   var dateFin = $(this).text(); 
           edit_data(idSanction, dateFin, "dateFin");  
      });
$(document).on('blur', '.periode', function(){  
           var idSanction = $(this).data("id9");  
		   var periode = $(this).text(); 
           edit_data(idSanction, periode, "periode");  
      });	  
});    	  
     </script> 